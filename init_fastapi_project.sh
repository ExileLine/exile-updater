...
Options:
  -n, --name NAME       Project package name. Default: ${DEFAULT_PROJECT_NAME}
...
if [[ ! "$PROJECT_NAME" =~ ^[A-Za-z_][A-Za-z0-9_]*$ ]]; then
  ...
  echo "Use a valid Python package name, for example: exile_updater" >&2
  exit 1
fi
...
class BaseConfig(BaseSettings):
    ...
    POSTGRESQL_DATABASE: str = "${PROJECT_NAME}"
    ...
    CELERY_TASK_QUEUE: str = "${PROJECT_NAME}_task_queue"
